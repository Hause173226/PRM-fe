...
import { Car, Battery, Clock, Star, ArrowRight, Zap, Shield, Users } from 'lucide-react';
import VehicleCard from '../components/Common/VehicleCard';
import { mockVehicles, mockCategories } from '../data/mockData';

const HomePage: React.FC = () => {
  const featuredVehicles = mockVehicles.filter(v => v.isFeatured);
  const latestVehicles = mockVehicles.slice(0, 6);
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 text-blue-100 max-w-3xl mx-auto">
              Kết nối người mua và người bán xe điện, pin và phụ kiện một cách an toàn, tiện lợi
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Chúng tôi cam kết mang đến trải nghiệm mua bán tốt nhất cho cộng đồng xe điện Việt Nam
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Hệ thống xác minh nghiêm ngặt đảm bảo mọi giao dịch đều an toàn và minh bạch
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Nhanh chóng & Tiện lợi</h3>
              <p className="text-gray-600">
                Đăng tin dễ dàng, tìm kiếm thông minh và giao dịch nhanh chóng chỉ trong vài bước
              </p>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">Khám phá các loại sản phẩm phong phú</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-gray-600">Những chiếc xe được quan tâm nhiều nhất</p>
            </div>
            <Link
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-2">Tin đăng mới nhất</h2>
              <p className="text-gray-600">Cập nhật liên tục những chiếc xe mới nhất</p>
            </div>
            <Link
